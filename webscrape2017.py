...
# write the final product to a text file: only works for the last link in the list
	...
	fob = open('/Users/User/Desktop/Mine/Workspace/vs_workspace/IGF_Mining/Transcripts_2017/file_' + str(filenumber) + '.txt', 'w')
	fob.write(text)
	fob.close()
...
# rename the files appropriately by their names as appears on the link
	file_num = file_num + 1
	old_file = '/Users/User/Desktop/Mine/Workspace/vs_workspace/IGF_Mining/Transcripts_2017/file_' + str(file_num) + '.txt'
	new_file = '/Users/User/Desktop/Mine/Workspace/vs_workspace/IGF_Mining/Transcripts_2017/' + str(result) + '.txt'
