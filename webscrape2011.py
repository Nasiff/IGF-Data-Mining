...
FILE_DIR = '/Users/User/Desktop/Mine/Workspace/vs_workspace/IGF_Mining/Transcripts_2011/'

# send a GET request, pose as a Mozilla Firefox agent
url = "http://intgovforum.org/cms/2011-igf-nairobi/934-transcripts-"
...
begin = "http://www.intgovforum.org/cms/component/content/article/108-transcripts/856-main-session-internet-governance-for-development"
end = "http://www.intgovforum.org/cms/component/content/article/71-transcripts-/910-unesco-open-forum"
...
for element in final_list:
    try:
        ...
        same_file_first = same_file_first + 1
        result = str(same_file_first) + "CHECK"
